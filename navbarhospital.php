...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
      ...
      <a href="viewrequest.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">View Request</a>
      <a href="addbloodinfo.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Add Blood Info</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
      <a href="viewrequest.php" class="w3-bar-item w3-button w3-padding-large">View Request</a>
      <a href="addbloodinfo.php" class="w3-bar-item w3-button w3-padding-large">Add Blood Info</a>
